...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AgriConnect" },
      { name: "description", content: "AgriConnect agricultural marketplace" },
      { name: "author", content: "AgriConnect" },
      { property: "og:title", content: "AgriConnect" },
      { property: "og:description", content: "Agricultural marketplace and rescue coordination" },
